...
const SellerProfile = () => {
    ...
    useEffect(() => {
        ...
        axios.post('http://127.0.0.1:8000/api/seller/profile', obj).then(resp => {
            console.log(resp.data);
            setName(resp.data.seller_name);
            setEmail(resp.data.seller_email);
            setPass(resp.data.seller_pass);
            //   setInbox(resp.data);
    ...
    const saveChanges = () => {
        ...
        axios.post('http://127.0.0.1:8000/api/seller/profile/update', obj).then(resp => {
            console.log(resp.data);
            history("/seller/pr");
